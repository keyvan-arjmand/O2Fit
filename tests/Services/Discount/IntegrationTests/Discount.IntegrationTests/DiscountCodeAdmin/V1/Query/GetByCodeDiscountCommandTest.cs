...
namespace Discount.IntegrationTests.DiscountCodeAdmin.V1.Query;

public class GetByCodeDiscountCommandTest:BaseTestFixture
{
    //[Test]
    //public async Task GetByCodeDiscountCommand_GetDiscountByCodeFromDb_ReturnsDiscount()
    //{
    ...
    //    var result = await Testing.SendAsync(new GetByCodeDiscountQuery(command.Code));
