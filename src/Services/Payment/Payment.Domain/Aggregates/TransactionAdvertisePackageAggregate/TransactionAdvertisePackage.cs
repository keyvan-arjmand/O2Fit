...
namespace Payment.Domain.Aggregates.TransactionAdvertisePackageAggregate;

public class TransactionAdvertisePackage : AggregateRoot
{
    public ObjectId? PackageInfoId { get; set; } //diet
