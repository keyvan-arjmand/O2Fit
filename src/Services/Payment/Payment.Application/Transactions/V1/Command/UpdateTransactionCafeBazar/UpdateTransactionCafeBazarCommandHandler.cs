...
public class UpdateTransactionCafeBazarCommandHandler : IRequestHandler<UpdateTransactionCafeBazarCommand>
{
    private readonly IUnitOfWork _uow;
    private readonly IRequestClient<GetByIdPackage> _clientPackage;

    public UpdateTransactionCafeBazarCommandHandler(IUnitOfWork uow, IRequestClient<GetByIdPackage> clientPackage)
    {
        _uow = uow;
    ...
    public async Task Handle(UpdateTransactionCafeBazarCommand request, CancellationToken cancellationToken)
    {
