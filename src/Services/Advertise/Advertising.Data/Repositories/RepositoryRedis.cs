...
namespace Data.Repositories
{
    public class RepositoryRedis<TData> : IRepositoryRedis<TData>, IScopedDependency
    {
        ...
        public async Task<List<TData>> GetAllWithNullAsync(List<string> keys)
        {
            RedisKey[] allKeys = new RedisKey[keys.Count];
        ...
        public async Task<TData> UpdateAsync(string key, TData entity)
        {
            var _values = await _context.Redis.StringSetAsync(key, JsonConvert.SerializeObject(entity));
        ...
        public async Task<TData> UpdateDisableLoopAsync(string key, TData entity)
        {
            var _values = await _context.Redis.StringSetAsync(key, JsonConvert.SerializeObject(entity, new JsonSerializerSettings()
            {
