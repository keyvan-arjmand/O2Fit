...
namespace Identity.Application.Common.EnumExtensions;
...
public static class EnumExtensions
{
    ...
    public static string GetDescriptionValue(this Enum value, DisplayProperty property = DisplayProperty.Description)
    {
        var attribute = value.GetType().GetField(value.ToString())
            .GetCustomAttributes<DescriptionAttribute>(false).FirstOrDefault();
        if (attribute == null)
