...
using Track.Application.Common.Models;
using Track.Application.Common.Utilities;
using Track.Infrastructure.Common;
...
public class GenericRepository<T> : IGenericRepository<T> where T : AggregateRoot
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        definition = definition.Set(x => x.LastModifiedById, _currentUserService.UserId.StringToInt());
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        update = update.Set(x => x.LastModifiedById, _currentUserService.UserId.StringToInt());
