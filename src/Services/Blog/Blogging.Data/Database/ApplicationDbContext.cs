...
namespace Data.Database
{
    ...
    //DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Blog>().HasQueryFilter(f => !f.IsDelete);
            modelBuilder.Entity<SubCategory>().HasQueryFilter(f => !f.IsDelete);
            modelBuilder.Entity<Category>().HasQueryFilter(f => !f.IsDelete);
            base.OnModelCreating(modelBuilder);
