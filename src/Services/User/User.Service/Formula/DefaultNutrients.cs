...
namespace User.Service.Formula
{
    ...
    {
        public static string DailyNutrients(int age, Gender gender)
        {
            string defaultNutrient = "";
            ...
            if ((Gender)gender == Gender.Female)
            {
                ...
                if (age > 50 && age <= 70) defaultNutrient = "0,2200,3500,0,4700,700,1300,2.4,320,0,8,0,55,1.5,0,1.1,14,50,8,75,700,90,0.9,0,5,10000,2500,14,400,11,1.1,0,0,15";
