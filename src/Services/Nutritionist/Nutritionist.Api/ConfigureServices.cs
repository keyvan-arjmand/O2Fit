...
public static class ConfigureServices
{
    public static IServiceCollection AddWebApiServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Version = "v1.0",
                Title = "Nutritionist V2 Api V1",
                Description = "Nutritionist V2 Api V1",
            });
            options.SwaggerDoc("v2", new OpenApiInfo
            {
                Version = "v2.0",
                Title = "Nutritionist V2 V2",
                Description = "Nutritionist V2 Api V2",
            });
            options.AddSecurityDefinition("OAuth2", new OpenApiSecurityScheme
            {
                ...
                Flows = new OpenApiOAuthFlows
                {
                    Password = new OpenApiOAuthFlow
                    {
                        ...
                        {
                            { "nutritionist_api", "nutritionist_api" }
                        }
                    },
                },
        ...
        services.AddMassTransit(x =>
        {
            var entryAssembly = AppDomain.CurrentDomain.GetAssemblies()
                .FirstOrDefault(f => f.FullName!.Contains("Nutritionist.Application"));
        ...
        services.AddOpenIddict()
            .AddValidation(options =>
            {
                ...
                options.AddAudiences(configuration["IdentitySettings:Audiences:NutritionistResource"]!);
