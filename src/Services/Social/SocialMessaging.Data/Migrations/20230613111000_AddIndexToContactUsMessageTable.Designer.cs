...
namespace SocialMessaging.Data.Migrations
{
    ...
    [Migration("20230613111000_AddIndexToContactUsMessageTable")]
    partial class AddIndexToContactUsMessageTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMessaging.Domain.Entities.ContactUs.ContactUsMessage", b =>
                {
                    ...
                    b.HasIndex("IsReadAdmin", "IsForce", "IsGeneral", "ToAdmin");
            ...
            modelBuilder.Entity("SocialMessaging.Domain.Entities.Translation.TranslationDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("TranslationDtos");
                });

            modelBuilder.Entity("SocialMessaging.Domain.Entities.App.AppVersion", b =>
                {
                    b.HasOne("SocialMessaging.Domain.Entities.Translation.TranslationDto", "Description")
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMessaging.Domain.Entities.Market.MarketMessage", b =>
                {
                    b.HasOne("SocialMessaging.Domain.Entities.Translation.TranslationDto", "ButtonName")
                        .WithMany()
                    ...
                    b.HasOne("SocialMessaging.Domain.Entities.Translation.TranslationDto", "Title")
                        .WithMany()
