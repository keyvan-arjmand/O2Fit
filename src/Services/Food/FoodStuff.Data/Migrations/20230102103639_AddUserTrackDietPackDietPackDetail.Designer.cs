...
namespace FoodStuff.Data.Migrations
{
    ...
    [Migration("20230102103639_AddUserTrackDietPackDietPackDetail")]
    partial class AddUserTrackDietPackDietPackDetail
    {
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDetail", b =>
                {
                    ...
                    b.Property<int?>("UserTrackDietPackDetailId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserTrackDietPackDetailId");

                    b.ToTable("UserTrackDietPackDetails");
                });

            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDietPackDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("UserTrackDietPackDietPackDetails");
                });
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDetail", b =>
                {
                    ...
                    b.HasOne("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDietPackDetail", "TrackDietPackDietPackDetail")
                        .WithMany("UserTrackDietPackDetails")
                        .HasForeignKey("UserTrackDietPackDetailId");
                });

            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDietPackDetail", b =>
                {
                    b.HasOne("FoodStuff.Domain.Entities.Diet.UserTrackDietPack", "UserTrackDietPack")
                        .WithMany("UserTrackDietPackDietPackDetails")
