...
namespace FoodStuff.Data.Migrations
{
    ...
    [Migration("20230102074147_AddUserTrackDietPackDate")]
    partial class AddUserTrackDietPackDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPack", b =>
                {
                    ...
                    b.Property<int?>("UserTrackDietPackDateId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("UserTrackDietPackDateId");

                    b.ToTable("UserTrackDietPacks");
                });

            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("UserTrackDietPackDates");
                });
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.UserTrackDietPack", b =>
                {
                    b.HasOne("FoodStuff.Domain.Entities.Diet.UserTrackDietPackDate", "UserTrackDietPackDate")
                        .WithMany("UserTrackDietPacks")
                        .HasForeignKey("UserTrackDietPackDateId");
                });
