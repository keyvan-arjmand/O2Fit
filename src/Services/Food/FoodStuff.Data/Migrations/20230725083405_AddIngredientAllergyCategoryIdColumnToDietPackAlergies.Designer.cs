...
namespace FoodStuff.Data.Migrations
{
    ...
    [Migration("20230725083405_AddIngredientAllergyCategoryIdColumnToDietPackAlergies")]
    partial class AddIngredientAllergyCategoryIdColumnToDietPackAlergies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.DietPackAlerge", b =>
                {
                    ...
                    b.Property<int?>("IngredientAllergyCategoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IngredientAllergyCategoryId");
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.Food", b =>
                {
                    ...
                    b.HasIndex("IsActive", "IsDelete", "Tag", "FoodType");
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.IngredientAllergyCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("IngredientAllergyCategories");
                });

            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.IngredientAllergyCategoryIngredientAllergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("IngredientAllergyId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IngredientAllergyId")
                        .HasName("IX_IngredientAllergyCategoryIngredientAllergies_IngredientAll~1");

                    b.ToTable("IngredientAllergyCategoryIngredientAllergies");
                });
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.RecipeStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.Tip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Diet.DietPackAlerge", b =>
                {
                    ...
                    b.HasOne("FoodStuff.Domain.Entities.Food.IngredientAllergyCategory", "IngredientAllergyCategory")
                        .WithMany("DietPackAlerges")
                        .HasForeignKey("IngredientAllergyCategoryId");
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.IngredientAllergyCategoryIngredientAllergy", b =>
                {
                    b.HasOne("FoodStuff.Domain.Entities.Food.IngredientAllergyCategory", "IngredientAllergyCategory")
                        .WithMany("IngredientAllergyCategoryIngredientAllergy")
                        .HasForeignKey("IngredientAllergyCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FoodStuff.Domain.Entities.Food.IngredientAllergy", "IngredientAllergy")
                        .WithMany("IngredientAllergyCategoryIngredientAllergy")
                        .HasForeignKey("IngredientAllergyId")
                        .HasConstraintName("FK_IngredientAllergyCategoryIngredientAllergies_IngredientAll~1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.Recipe", b =>
                {
                    b.HasOne("FoodStuff.Domain.Entities.Food.Food", "Food")
                        .WithOne("Recipe")
                        .HasForeignKey("FoodStuff.Domain.Entities.Food.Recipe", "FoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FoodStuff.Domain.Entities.Food.RecipeStep", b =>
                {
                    ...
                    b.HasOne("FoodStuff.Domain.Entities.Food.Recipe", "Recipe")
