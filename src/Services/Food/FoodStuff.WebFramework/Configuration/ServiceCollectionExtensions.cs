...
namespace WebFramework.Configuration
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddCustomDapper(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                return new SqlConnectionFactory(configuration.GetConnectionString("Npgsql"));
            });
        }
                ...
                options.Events = new JwtBearerEvents
                {
                    OnAuthenticationFailed = context =>
                    {
                        if (context.Exception != null)
                            throw new AppException(ApiResultStatusCode.UnAuthorized, "Authentication failed. For Me!!!", HttpStatusCode.Unauthorized, context.Exception, null);
