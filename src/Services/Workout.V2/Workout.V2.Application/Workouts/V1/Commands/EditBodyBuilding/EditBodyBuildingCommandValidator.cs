...
public class EditBodyBuildingCommandValidator : AbstractValidator<EditBodyBuildingCommand>
{
    public EditBodyBuildingCommandValidator()
    {
        ...
        RuleForEach(x => x.BodyMuscleIds).NotEmpty().WithMessage("BodyMuscleIds can not be empty").NotNull()
            .WithMessage("BodyMuscleIds can not be null");
