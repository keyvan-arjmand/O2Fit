...
public class SubtractUsableDiscountO2FitCommandHandler : IRequestHandler<SubtractUsableDiscountO2FitCommand>
{
    private readonly IUnitOfWork _uow;

    public SubtractUsableDiscountO2FitCommandHandler(IUnitOfWork uow)
    {
        _uow = uow;
    }
