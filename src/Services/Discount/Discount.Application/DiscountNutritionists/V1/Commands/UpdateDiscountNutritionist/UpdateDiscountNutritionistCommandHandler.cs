...
using Discount.Application.DiscountO2Fits.V1.Commands.UpdateDiscountO2Fit;
...
public class UpdateDiscountNutritionistCommandHandler:IRequestHandler<UpdateDiscountO2FitCommand>
{
    private readonly IUnitOfWork _uow;

    public UpdateDiscountNutritionistCommandHandler(IUnitOfWork uow)
    {
        _uow = uow;
    }
