...
public class CurrentUserService : ICurrentUserService
{
    ...
    public string? NutritionistProfileImageName => _httpContextAccessor.HttpContext?.User?.FindFirstValue(CustomClaimsConstants.NutritionistProfileImageNameClaim);
