...
public class
    IncreaseNutritionistBannerAdvertiseClickCountCommandHandler : IRequestHandler<
        IncreaseNutritionistBannerAdvertiseClickCountCommand>
{
    private readonly IUnitOfWork _uow;

    public IncreaseNutritionistBannerAdvertiseClickCountCommandHandler(IUnitOfWork uow)
    {
        _uow = uow;
    }

    public async Task Handle(IncreaseNutritionistBannerAdvertiseClickCountCommand request,
