...
public class RoleGenericRepository<T> : IRoleGenericRepository<T> where T : RoleAggregateRoot
{
    private readonly IMediator _mediator;
    private readonly IConfiguration _configuration;
    public IMongoCollection<T> Collection { get; }
    private readonly IMongoClient _mongoClient;
    public RoleGenericRepository(IMediator mediator, IConfiguration configuration)
    {
        _mediator = mediator;
