...
public class UserGenericRepository<T> : IUserGenericRepository<T> where T : UserAggregateRoot
{
    private readonly IMediator _mediator;
    private readonly IConfiguration _configuration;
    public IMongoCollection<T> Collection { get; }
    private readonly IMongoClient _mongoClient;
    public UserGenericRepository(IMediator mediator, IConfiguration configuration)
    {
        _mediator = mediator;
    ...
    {
        var result = await Collection.FindAsync(x => x.Id == id && !x.IsDelete, null, cancellationToken).ConfigureAwait(false);
    ...
    public async Task<IAsyncCursor<T>> GetByFilterAsync(FilterDefinition<T> filter, FindOptions<T> options, CancellationToken cancellationToken = default)
    {
    ...
    public Task<T?> GetSingleDocumentByFilterWithSortAsync(FilterDefinition<T> filter, Expression<Func<T, object>> sort,
        CancellationToken cancellationToken = default)
    {
        return Collection.Find(filter).SortByDescending(sort).Limit(1).FirstOrDefaultAsync(cancellationToken);
    }

    public Task<List<T>> GetListOfDocumentsByFilterAsync(FilterDefinition<T> filter, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<long> LongCountAsync(Expression<Func<T, bool>>? predicate = null, CancellationToken cancellationToken = default)
    {
        IMongoQueryable<T> source = Collection.AsQueryable<T>();
        return predicate != null ?
    ...
    public async Task<TResult> MaxAsync<TResult>(Expression<Func<T, TResult>> selector, Expression<Func<T, bool>>? predicate = null,
        CancellationToken cancellationToken = default)
    {
        if (selector is null)
    ...
    public async Task<TResult> MinAsync<TResult>(Expression<Func<T, TResult>> selector, Expression<Func<T, bool>>? predicate = null,
        CancellationToken cancellationToken = default)
    {
        if (selector is null)
            throw new ArgumentNullException(nameof(selector), "selector cannot be null.");
    ...
    public async Task<UpdateResult> UpdateOneAsync(Expression<Func<T, bool>> predicate, T aggregateRoot, Expression<Func<T, object>>[] properties, UpdateOptions? options = null,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<UpdateResult> UpdateOneAsync(Expression<Func<T, bool>> predicate, IDictionary<Expression<Func<T, object>>, object> properties,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (properties is null || !properties.Any())
            throw new ArgumentException("properties cannot be null or empty.", nameof(properties));
        UpdateDefinition<T>? definition = (UpdateDefinition<T>)null;
        foreach (KeyValuePair<Expression<Func<T, object>>, object> property in (IEnumerable<KeyValuePair<Expression<Func<T, object>>, object>>)properties)
            definition = definition != null ? definition.Set<T, object>(property.Key, property.Value) : Builders<T>.Update.Set<object>(property.Key, property.Value);
    ...
    public async Task<UpdateResult> UpdateOneAsync(FilterDefinition<T> filter, T aggregateRoot, UpdateDefinition<T> update, UpdateOptions? options = null,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task<UpdateResult> UpdateManyAsync(FilterDefinition<T> filter, T aggregateRoot, UpdateDefinition<T> update, UpdateOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        await _mediator.DispatchDomainEventsAsync(aggregateRoot);
    ...
    public async Task<BulkWriteResult<T>> BulkWriteAsync(IEnumerable<WriteModel<T>> requests, IEnumerable<T> aggregateRoots,
    ...
    public async Task<ReplaceOneResult> ReplaceOneAsync(Expression<Func<T, bool>> predicate, T aggregateRoot, ReplaceOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        if (predicate is null)
            throw new ArgumentNullException(nameof(predicate), "predicate cannot be null.");
    ...
    public async Task<DeleteResult> DeleteOneAsync(Expression<Func<T, bool>> predicate, T aggregateRoot, DeleteOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        if (predicate is null)
            throw new ArgumentNullException(nameof(predicate), "predicate cannot be null.");
    ...
    public async Task<UpdateResult> SoftDeleteByIdAsync(ObjectId id, T aggregateRoot, UpdateOptions? options = null,
        CancellationToken cancellationToken = default)
    {
