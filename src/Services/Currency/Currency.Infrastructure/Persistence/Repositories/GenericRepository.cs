...
namespace Currency.Infrastructure.Persistence.Repositories;
...
public class GenericRepository<T> : IGenericRepository<T> where T : AggregateRoot
{
    ...
    public async Task<T?> GetSingleDocumentByFilterAsync(FilterDefinition<T> filter,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _currentUserService.UpdateAuditLog(aggregateRoot);
